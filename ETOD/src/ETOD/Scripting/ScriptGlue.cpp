...
#define ETOD_ADD_INTERNAL_CALL(Name) mono_add_internal_call("ETOD.InternalCalls::" #Name, Name)
	...
	static MonoString* TextComponent_GetText(UUID entityID)
	{
		...
		Entity entity = scene->GetEntityByUUID(entityID);
		ETOD_CORE_ASSERT(entity);
		ETOD_CORE_ASSERT(entity.HasComponent<TextComponent>());
	...
	void ScriptGlue::RegisterFunctions()
	{
		...
		ETOD_ADD_INTERNAL_CALL(TextComponent_GetText);
		ETOD_ADD_INTERNAL_CALL(TextComponent_SetText);
		ETOD_ADD_INTERNAL_CALL(TextComponent_GetColor);
		ETOD_ADD_INTERNAL_CALL(TextComponent_SetColor);
		ETOD_ADD_INTERNAL_CALL(TextComponent_GetKerning);
		ETOD_ADD_INTERNAL_CALL(TextComponent_SetKerning);
		ETOD_ADD_INTERNAL_CALL(TextComponent_GetLineSpacing);
		ETOD_ADD_INTERNAL_CALL(TextComponent_SetLineSpacing);
