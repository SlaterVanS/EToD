	...
	: Layer("ExampleLayer"), m_CameraController(1280.0f / 720.0f)
{
	...
	m_ChernoLogoTexture = ETOD::Texture2D::Create("assets/textures/EToD_Engine.png");
...
void ExampleLayer::OnUpdate(ETOD::Timestep ts)
{
	// Update
...
void ExampleLayer::OnEvent(ETOD::Event& e)
{
